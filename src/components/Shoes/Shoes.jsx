...
function Shoes() {
  ...
  const allshoes = Allcartproduct.filter((data) => {
  ...
  const [shoesinput, setinputvalue] = useState(allshoes)
                ...
                <section className="box  d-inline-block  ">
                  <div className="content ">
                    ...
                    <div className="left">
                      ...
                      <div className="product_details ms-3 mt-2">
                        <span className='mt-2 highlight'>{data.name}</span >
                    ...
                    <div className="right">
                      <div className="product_description">
                        ...
                        <p><span className='highlight'>Product Name  - </span>
                          {data.name}</p>
                        ...
                        <div className="button">
                          ...
                          {
                            isLogin ? <button class="btn btn-success mt-3 addcart" onClick={() => handleCart(data.id, data)}>ADD TO CART</button> :

                              <>
                                <button class="btn btn-danger  addcart1" onClick={() => handleCart(data.id, data)} disabled>ADD TO CART</button>
                                <br />
